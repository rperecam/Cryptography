...
##  Contexto Académico y Punto de Partida
...
##  El Algoritmo Clásico: Análisis y Limitaciones

###  Comparativa BSGS vs. Pollard Rho
...
###  Funcionamiento del Algoritmo Estándar
...
##  Cronología del Proyecto y Toma de Decisiones

###  Fase 1 — Implementación Base y Comprensión del Problema
...
###  Fase 2 — Identificación de los Vectores de Mejora
...
###  Fase 3 — Diseño del Espacio de Búsqueda
...
###  Fase 4 — Definición de la Métrica de Evaluación
...
###  Fase 5 — Ejecución, Análisis y Documentación
...
##  Metodología: Diseño del Espacio de Búsqueda
...
###  Aumento del Número de Particiones (K)
...
###  Caminatas de Teske: Eliminar la Elevación al Cuadrado
...
###  Selector de Entropía por Desplazamiento de Bits
...
##  Justificación Teórica: Invariante del Grupo
...
###  Demostración para las Caminatas de Teske
...
###  Por qué el Selector de Entropía No Rompe el Invariante
...
###  Estabilidad del Ratio a Través de los Espectros
...
###  Distribución de Scores del Grid Search
...
###  Impacto del Método de Entropía
...
###  Impacto de la Estrategia Iterativa
...
###  Sobre la Naturaleza de la Mejora
...
###  Por qué el Profesor Tiene Razón al Pedir esto
